...
| temp_step_template               | [`template`](https://www.home-assistant.io/docs/configuration/templating) | Defines a template to get the step size for temperature set point. Overrides value specified by `temp_step`.                                                                                                                                                                                    |                                                    |
