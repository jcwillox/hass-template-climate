...
| swing_horizontal_mode_template   | [`template`](https://www.home-assistant.io/docs/configuration/templating) | Defines a template to get the swing horizontal mode of the climate device.                                                                                                                                                                                                                      |                                                    |
...
| set_swing_horizontal_mode        | [`action`](https://www.home-assistant.io/docs/scripts)                    | Defines an action to run when the climate device is given the set swing horizontal mode command. Can use `swing_horizontal_mode` variable.                                                                                                                                                      |                                                    |
|                                  |                                                                           |                                                                                                                                                                                                                                                                                                 |                                                    |
...
| swing_horizontal_modes           | `list`                                                                    | A list of supported swing horizontal modes.                                                                                                                                                                                                                                                     | ["on", "off"]                                      |
|                                  |                                                                           |                                                                                                                                                                                                                                                                                                 |                                                    |
